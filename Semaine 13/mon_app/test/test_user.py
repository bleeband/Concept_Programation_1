...
from mon_package.adress import Address

class TestUser(unittest.TestCase):

    @classmethod
    def setUpClass(cls) -> None:
        print("Avant le début des tests - TestUser")
        address = Address("Montréal", "Canada")
        cls.user = User("Lilia", address)
